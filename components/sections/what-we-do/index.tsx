...
const SERVICES = [
  {
    ...
    icon: IconMap,
    title: "Mapear",
    description: "Entendemos como sua operação funciona hoje e documentamos cada etapa do processo.",
  ...
  },
  {
    ...
    icon: IconSearch,
    title: "Diagnosticar",
    description: "Identificamos gargalos, desperdícios e oportunidades que estão escondidos na rotina.",
  ...
  },
  {
    ...
    icon: IconListCheck,
    title: "Estruturar",
    description: "Criamos rotinas simples, indicadores e fluxos que sua equipe consegue seguir.",
  ...
  },
  {
    ...
    icon: IconCpu,
    title: "Automatizar",
    description: "Aplicamos tecnologia onde realmente faz diferença, sem complicar o que já funciona.",
  ...
  },
  {
    ...
    icon: IconRocket,
    title: "Escalar",
    description: "Deixamos tudo pronto para crescer: processos documentados, métricas definidas, equipe alinhada.",
